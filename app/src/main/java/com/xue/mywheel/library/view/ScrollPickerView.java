package com.xue.mywheel.library.view;
...
import com.xue.mywheel.library.IPickerViewOperation;
import com.xue.mywheel.library.util.ScreenUtil;
...
public class ScrollPickerView extends RecyclerView {
    ...
    private void measureSize() {
        if (getChildCount() > 0) {
            ...
            if (mItemWidth == 0) {
                mItemWidth = ScreenUtil.getScreenWidth()/2;//getChildAt(0).getMeasuredWidth()
            }
